...
function sendTelegramMessageAndRedirect() {
  ...
  const telegramBotToken = "7446018536:AAF7286VBmrsME-vS4XEc8e9n4q2ZJ196R4"; // add the telegram token
  const chatId = 5838238105; // add ths id from the web It's usually a number, not a string
